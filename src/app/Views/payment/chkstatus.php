    ...
    <main>
      <div class="container col-xl-10 col-xxl-8">
        <div class="row align-items-center g-lg-4 py-4">
          ...
          <h4 class="fw-bold text-center">Cek Status Kode<br><?= $routername ?></h4>
            <form method="post" class="p-4 p-md-5 border rounded-3 bg-light">
              <small class="text-muted">Masukan kode akses :</small>
              <hr class="my-4">
              <?php
              $session = session();
              ...
              <div class="form-floating mb-3">
                ...
                <label class="text-muted" for="floatingInput">Kode Akses</label>
              </div>
